...
<body>
    <header id="header">
        ...
        <div class="container">
            ...
            <div class="logo float-left">
                ...
                <h1 class="text-light"><a href="#intro" class="scrollto"><span>AposentePrev</span></a></h1>
            ...
            <nav class="main-nav float-right d-none d-lg-block">
                <ul>
                    ...
                    <li><a href="#portfolio">Aposentadoria por profissão</a></li>
                    <li><a href="#team">Vídeos</a></li>
        ...
        <div class="container d-flex h-100">
            <div class="row justify-content-center align-self-center">
                <div class="col-md-6 intro-info order-md-first order-last">
                    <h2>AposentePrev<br>Você consultando mais rápido sua <span>Aposentadoria!</span></h2>
                    <div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-6">
                        <div class="about-content">
                            ...
                            <p>  
                                O sócio fundador Rafael Gabarra percebeu que a tendência do mercado da advocacia não se diferenciava da tendência do mercado de prestação de serviços em geral, cada dia mais a sociedade exige eficiência e resultado.
                            </p>
                                <p>  
                                A especialização das bancas de advocacia foi a forma encontrada para que a prestação de serviço se apure, é algo natural, quanto mais se estuda e se experimenta uma específica matéria, melhores resultados serão alcançados. 
                            </p>
                            <p>  
                                De forma inovadora, Gabarra Sociedade de Advogados passou a contemplar estudos e trabalhos focados no direito previdenciário, suas origens, ramificações e consequências. Fixou sua sede no interior do estado de São Paulo e passou a integrar a vanguarda da advocacia previdenciária no estado.
                            </p>
  ...
  ============================-->
    <footer id="footer" class="section-bg">
        ...
        <div class="container">
            <div class="copyright">
                &copy; Copyright <strong>AposentePrev</strong>. All Rights Reserved
            </div>
            <div class="credits">
                Designed by <a href="https://pktecnologia.com/">Bruno Luiz Purcinelli</a>
            </div>
        </div>
    </footer>
    <!-- #footer -->
